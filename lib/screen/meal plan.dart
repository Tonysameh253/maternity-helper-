// ignore_for_file: sort_child_properties_last, duplicate_ignore, prefer_const_constructors, avoid_print, unused_import, unnecessary_import, camel_case_types, file_names
...
class mealplan extends StatefulWidget {
  const mealplan({super.key, required this.title});
  final String title;
  @override
